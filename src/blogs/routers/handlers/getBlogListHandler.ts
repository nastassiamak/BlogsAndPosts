...
export async function getBlogListHandler(
  ...
  try {
    const queryInput = {
      ...
      searchBlogDescriptionTerm: req.query.searchBlogDescriptionTerm as
        | string
        | undefined,
    };
    ...
    const responsePayload = mapToBlogListPaginatedOutput(
    ...
    res
      ...
      .json({ message: (error as Error).message || "Invalid query" });
  }
}
